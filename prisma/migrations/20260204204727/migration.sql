/*
  ...
  - You are about to alter the column `stock_released_at` on the `pharmacy_orders` table. The data in that column could be lost. The data in that column will be cast from `Timestamp(0)` to `Timestamp`.
...
ALTER TABLE `pharmacy_orders` MODIFY `picked_up_at` TIMESTAMP NULL,
    ...
    MODIFY `stock_released_at` TIMESTAMP NULL;
