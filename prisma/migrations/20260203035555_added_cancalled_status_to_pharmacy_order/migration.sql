...
-- AlterTable
ALTER TABLE `pharmacy_orders` MODIFY `status` ENUM('PENDING', 'ACCEPTED', 'REJECTED', 'PREPARING', 'CANCELLED', 'READY_FOR_PICKUP', 'PICKED_UP', 'COMPLETED') NOT NULL DEFAULT 'PENDING',
